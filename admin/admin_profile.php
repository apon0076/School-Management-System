            ...
            <form action="#" method="post" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="col-md-2">
                    	<?php
                    	if (!isset($_GET['edit'])) { ?>
                        	<a href="admin_profile.php?edit=<?php echo true; ?>" class="profile-edit-btn">Edit Profile</a>
                    	<?php
                    	}
                    	?>
                        	<a href="admin_profile.php" class="profile-edit-btn">Refresh</a>
                    </div>
                </div>
                <div class="row">
                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                            	...
                                            	<input type="hidden" name="aid" value="<?php echo $row['admin_id']; ?>">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
        ...
        if (isset($_POST['update'])) {
        	...
        	$image=$_FILES['image']['name'];
        		...
        		if (isset($_FILES['image']['name']) && !empty($_FILES['image']['name'])) {
		        	$sql="UPDATE admin SET name='$name', mail='$mail', phone='$phone', image='$image' WHERE admin_id='$aid'";
        		...
        		{
		        	$sql="UPDATE admin SET name='$name', mail='$mail', phone='$phone' WHERE admin_id='$aid'";
